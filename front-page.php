...
We got you covered</h2>
      ...
      <div class="row justify-content-center pt-4 espacio-arriba-p">
         <div class="col-md-12">
           <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/portfolio/raven-downBTN.png" alt=""></a>
         </div>
      </div>
    </div>
    </div>
...
<!--====SECCION N°3===-->
  <section class="fondo-negro espacio-arriba-p">
      <div class="container">
           <div class="row">
              <div class="col-md-3">
         ...
         <div class="col-md-12 text-center">
           <a href="#"><img class="img-fluid img-centro" src="<?php echo get_template_directory_uri(); ?>/img/portfolio/raven-downBTN.png" alt=""></a>
         </div>
      </div>
      </div>
  </section>
...
<!--====SECCION N°6===-->
  ...
  <!--====SECCION N°7===-->
  <section class="fondo" id="portfolio">
    <div class="transparente espacio-arriba-p espacio-bottom-p">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
