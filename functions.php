...
function wp_theme_main_style(){
  ...
  wp_enqueue_style('fontawesome',get_template_directory_uri().'/assets/vendor/fontawesome/css/all.min.css',false);
...
<p class="woocommerce-LostPassword lost_password">
  <a href="<?php echo get_site_url(); ?>/lost-password/"><?php esc_html_e( 'Lost your password?', 'woocommerce' ); ?></a>
  <a href="<?php echo get_site_url(); ?>/register/"><?php esc_html_e( 'Register', 'woocommerce' ); ?></a>
</p>
...
add_shortcode( 'wc_forgot_password_dashboard', 'wc_forgot_password' );
    
function wc_forgot_password() {
if ( is_admin() ) return;
if ( is_user_logged_in() ) return;
ob_start();
